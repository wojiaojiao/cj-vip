...
function openplayer1(b, a) {	
    
	burl1 = "http://v.72du.com/api/?url=" + encodeURIComponent(b.pageUrl);//视频地址解析接口1
    ...
    chrome.tabs.query({
        ...
        chrome.tabs.update(c[0].id, {
            url: burl1 + "&title=" + encodeURI(c[0].title)
        })
    })
		
}

function openplayer2(b, a) {	

	burl2 = "http://000o.cc/jx/ty.php?url=" + encodeURIComponent(b.pageUrl);//视频地址解析接口2
	...
	chrome.tabs.query({
        ...
        chrome.tabs.update(c[0].id, {
            url: burl2 + "&title=" + encodeURI(c[0].title)
        })
    })
...
chrome.webRequest.onBeforeRequest.addListener(
    ...
    {
        urls: [
            //"http://v.aty.sohu.com/crossdomain.xml"//souhu广告
			"https://pcbrowser.dd.qq.com/pcbrowserbig/qbextension/update/20161016/lfamimmlickbeelcmighegbkiipijmog.crx"
